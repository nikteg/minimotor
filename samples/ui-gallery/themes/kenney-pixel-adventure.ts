...
export function createKenneyPixelAdventureTheme(atlas: CanvasImageSource): Partial<Theme> {
...
export async function loadKenneyPixelAdventureTheme(Assets: AssetStore): Promise<Partial<Theme>> {
