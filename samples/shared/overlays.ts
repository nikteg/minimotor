...
import type { DrawApi } from "minimotor";

export function createOverlays(Draw: DrawApi) {
  ...
  function drawGameOver(w: number, h: number, score: number, best: number, restartHint?: string) {
  ...
  return { drawGameOver, drawLevelComplete };
}
