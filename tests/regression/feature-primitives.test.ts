// Cross-module regression coverage retained from the feature-primitives pass.
import { describe, expect, it } from "vitest";
import { approach, damp, lerpAngle, pingPong } from "@src/math/mathf.js";
import { circleRect, separateCircles, bounceInBounds } from "@src/collision/index.js";
import { formatClock } from "@src/goodies/scoring.js";
import { scoreTracker } from "@src/gizmos/scoring.js";
import { randFreeCell, shuffle, addToInventory, beatClock, nearest } from "@src/goodies/index.js";
import { patrol, trail, undoStack, seedRng } from "@src/gizmos/index.js";
import { grid } from "@src/ui/api.js";
import { selectUiApp } from "@src/ui/core/state.js";
import { createTestUiApp } from "@src/ui/__tests__/app-fixture.js";
import { createRoster } from "@src/net/index.js";
...
describe("UI.grid", () => {
  it("splits an area into even cells, minus the gap", () => {
    selectUiApp(createTestUiApp({} as CanvasRenderingContext2D));
