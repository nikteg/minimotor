...
// `rng: () => number` (default Math.random); pass `Gizmos.seedRng(n)` for
// seeded, replayable runs. The stateful gadgets — `seedRng` and `shuffleBag` —
// live in Gizmos.
...
export function damageRoll(base, options = {}, rng = Math.random) {
