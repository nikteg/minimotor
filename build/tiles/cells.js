...
export function blitCell(ctx, cell, x, y, w, h) {
...
export function isDualLayer(value) {
    return typeof value.dual === "function";
}
 ...
 */
export function orient(cell, opts) {
    const turn = (((opts.turn ?? 0) + (cell.turn ?? 0)) % 4);
    return {
        ...cell,
...
export function cellHash(cx, cy) {
