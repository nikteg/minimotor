...
import type { SlopeDirection, Solid, SolidSource } from "../collision/index.js";
...
export type TileSetEntry = readonly [column: number, row: number] | readonly [column: number, row: number, columns: number, rows: number];
...
export type TileSet<N extends string> = {
    readonly [K in N]: Cell;
} & {
...
export interface TileWorldOptions<A extends string, L extends Record<string, TileSpec>> extends GridOptions<L> {
