...
export const Mat4 = {
    ...
    compose(position, rotation, scale, out) {
    ...
    perspective(fovY, aspect, near, far, zeroToOne = false, out) {
        const dst = out ?? Mat4.create();
     ...
     *  `zeroToOne`. */
    ortho(left, right, bottom, top, near, far, zeroToOne = false, out) {
        const dst = out ?? Mat4.create();
    ...
    lookAt(eye, at, up, out) {
        ...
        let zx = eye.x - at.x, zy = eye.y - at.y, zz = eye.z - at.z;
