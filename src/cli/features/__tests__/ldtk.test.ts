...
import { checkLDtk, generateLDtkTypes, type LDtkProject } from "@src/cli/features/ldtk.js";
...
describe("mm ldtk types", () => {
  ...
  it("reports broken portal references", () => {
    ...
    expect(result.errors).toContain("Forest/Door: To references missing entity missing");
  });
});
