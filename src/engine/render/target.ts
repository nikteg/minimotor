// ---------- Scene renderer ----------
// The GPU (or a no-op Canvas2D stand-in) that `Draw.sprites` / `Draw.tiles` /
// `Draw.particles` talk to when a scene layer is attached. Everything else
// (`Draw.rect`, text, UI) stays on the overlay 2D context.
