...
const surfaces: CanvasRenderingContext2D[] = [];
...
export function pushUiSurface(ctx: CanvasRenderingContext2D): void {
  surfaces.push(ctx);
}

/** Leave the innermost render surface. */
export function popUiSurface(): void {
  surfaces.pop();
}
...
export function inUiSurface(): boolean {
