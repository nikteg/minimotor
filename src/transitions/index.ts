...
import type { Viewport } from "@src/engine/index.js";
...
export function curtain(durationMs = 400, color = "#000"): Transition {
  return {
    durationMs,
    render(ctx, t, vp) {
      const half = (vp.w * t) / 2;
...
export function run(spec: Transition, phases: TransitionPhases): TransitionRun {
